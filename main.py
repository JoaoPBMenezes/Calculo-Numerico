...
CONFIG = {
    ...
    "levels": 4,              #Pode ser editado para testar novos casos, é relacionado ao tamnho da rede, pode aumentar ou diminuir o tamanho da rede'
